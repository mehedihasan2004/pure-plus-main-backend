...
-- CreateEnum
CREATE TYPE "EUserRole" AS ENUM ('PATIENT', 'DOCTOR', 'NURSE', 'ADMIN', 'PHARMACIST', 'LAB_TECHNICIAN', 'ACCOUNTANT', 'HOSPITAL_ADMINISTRATOR', 'IT_SUPPORT', 'SUPER_ADMIN');
...
CREATE TABLE "users" (
    ...
    "gender" "EGender",
    "image" TEXT,
    "role" "EUserRole" NOT NULL DEFAULT 'PATIENT',
